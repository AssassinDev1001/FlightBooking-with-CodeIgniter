	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				<li class="start ">
					<a href="/booking/index.php/CustomerController/customer_view">
					<i class="icon-users"></i>
					<span class="title">Customer</span>
					</a>
				</li>
				<li class="start ">
					<a href="/booking/index.php/FlightController/view">
					<i class="icon-plane"></i>
					<span class="title">Booking Status</span>
					</a>
				</li>
				<li class="start ">
					<a href="/booking/index.php/PhotoController/index">
					<i class="icon-picture"></i>
					<span class="title">Photo</span>
					</a>
				</li>
				<li class="start ">
					<a href="/booking/index.php/SettingController/index">
